...
### Other test cases for suggestion

### Suggestion on speed up the test for larger test
1. Use of parallelisation tools like(selenium grid) could also be helpful in bringing down execution time drastically. 
2. Breaking down test cases feature wise is good stretegy. it helps to identify errors promptly and very efficieny in parallel testing.
